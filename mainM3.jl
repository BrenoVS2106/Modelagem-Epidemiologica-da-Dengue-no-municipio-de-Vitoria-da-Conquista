...
β_mh = 0.1;                          # probabilidade de transmissão de I_m para humanos
Β = 0.76;                            # media de mordidas do mosquito  
k = 10.10;                           # numero de larvas por humano 
...
plot(V_x,R_0,xlim=(0,365),ylim=(0.3,1.3), label= "R_0", xlabel = "Dias")
